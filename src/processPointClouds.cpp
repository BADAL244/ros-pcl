...
/**********************************************************************/
template<typename PointT>
std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::SegmentPlaneXZ(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold)
{   
...
// template<typename PointT>
// typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::convertPoint(typename pcl::PointCloud<PointT>::Ptr cloud){
//     typename pcl::PointCloud<PointT>::Ptr msg(new pcl::PointCloud<PointT>);
//     uint8_t r, g, b;
...
//     float x_cloud = cloud->points[i].x;
//     float y_cloud = cloud->points[i].y;
//     float z_cloud = cloud->points[i].z;
//     r = cloud->points[i].r;
//     g = cloud->points[i].g;
//     b = cloud->points[i].b;
//     msg->points.push_back (pcl::PointXYZRGB (x_cloud, y_cloud, z_cloud,r , g ,b ));
//     }
...
template<typename PointT>
sensor_msgs::PointCloud2 ProcessPointClouds<PointT>::conversion(typename pcl::PointCloud<PointT>::Ptr cloud){
  cloud->header.frame_id = "zed2_camera_center";
